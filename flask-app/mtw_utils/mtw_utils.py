...
"""
import os, sys, uuid, json, datetime, time, ast, base64, io, re, pprint, gzip, arrow, html
...
def getLocalConfValue(conf):
    ...
    try:
        ...
        d['REFRESH_AFTER'] = int( conf.get('appconf', 'REFRESH_AFTER', fallback=20) )
        d['LOGOUT_AFTER']  = int( conf.get('appconf', 'LOGOUT_AFTER', fallback=20) )
