...
def update_stats(stat):
    ...
    if stat not in ['initial', 'actual', 'umls', 'umls_all', 'umls_raw', 'lookups', 'lookups_rest', 'js_all', 'js_parsers', 'js_elastic', 'xml_desc', 'xml_qualif', 'marc', 'training_base']:
    ...
    if stat in ['umls', 'umls_all', 'umls_raw', 'js_all', 'js_parsers', 'js_elastic', 'xml_desc', 'xml_qualif', 'training_base']:
